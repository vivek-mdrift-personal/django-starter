      ...
      >
        ...
        <Box sx={{ height: `calc(100% - 4.0625rem)` }}>
          <ScrollWrapper hidden={hidden}>
            <Box sx={{ p: theme => theme.spacing(4, 3, 3) }}>
            <Button  variant='contained' color='warning' sx={{ '& svg': { mr: 2 }, display: 'block',my: 3, mb: 2, width: '100%' }} onClick={handleUserProfileLeftSidebarToggle} >
